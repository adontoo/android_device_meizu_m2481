...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_m2481
TARGET_RECOVERY_DEVICE_MODULES := libinit_m2481
...
PRODUCT_COPY_FILES += \
    ...
    $(call find-copy-subdir-files,*,$(KERNEL_PATH)/system_dlkm/,$(TARGET_COPY_OUT_SYSTEM_DLKM)/lib/modules/6.1.25-android14-11-maybe-dirty)
...
# OTA assert
TARGET_OTA_ASSERT_DEVICE := m2481,meizu21Pro
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 9659432112  # (BOARD_SUPER_PARTITION_SIZE - 4 MiB)
